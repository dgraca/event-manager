...
class ZonesTable extends Component implements HasForms, HasTable
{
    ...
    public function table(Table $table): Table
    {
        ...
        return $table
            ...
            ->actions([
                Action::make('edit')
                ->label(__('Update'))
                ->url(fn (Zone $record): string => route('zones.edit', ['zone' => $record]))
            ...
            ->defaultSort('id', 'desc')
            ->recordUrl(
                fn (Model $record): string => route('zones.show', ['zone' => $record]),
            )
            //->striped()
