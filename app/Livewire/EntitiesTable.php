...
class EntitiesTable extends Component implements HasForms, HasTable
{
    ...
    public function table(Table $table): Table
    {
        ...
        return $table
            ...
            ->actions([
                Action::make('edit')
                ->label(__('Update'))
                ->url(fn (Entity $record): string => route('entities.edit', ['entity' => $record]))
            ...
            ->defaultSort('id', 'desc')
            ->recordUrl(
                fn (Model $record): string => route('entities.show', ['entity' => $record]),
            )
            //->striped()
