<x-app-layout>
    @section('breadcrumbs')
        {{ Breadcrumbs::render('tickets.show', $tickets) }}
    @endsection
    <div class="intro-y mt-8 flex flex-col items-center sm:flex-row">
        <h2 class="mr-auto text-lg font-medium">{{ __('Tickets Details') }}</h2>
        <div class="mt-4 flex w-full sm:mt-0 sm:w-auto">
{{--            <x-base.button--}}
{{--                class="mr-2 shadow-md ml-auto sm:ml-0"--}}
{{--                variant="primary"--}}
{{--                href="{{ route('tickets.edit', $tickets) }}"--}}
{{--                as="a"--}}
{{--                >--}}
{{--                <x-base.lucide--}}
{{--                        class="mr-2 h-4 w-4"--}}
...
{{--                </x-base.dialog.panel>--}}
{{--            </x-base.dialog>--}}
{{--            <form method="POST" action="{{ route('tickets.destroy', $tickets) }}" id="delete-record-form">--}}
{{--                @csrf--}}
{{--                @method('DELETE')--}}
{{--            </form>--}}
        </div>
