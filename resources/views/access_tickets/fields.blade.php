...
<div class="mb-3">
    <x-base.form-label
            for="event_session_ticket_id">{{ $accessTickets->getAttributeLabel('event_session_ticket_id') }}</x-base.form-label>
    <x-base.form-input
...
<div class="mb-3">
    <x-base.form-label
            for="payment_option_id">{{ $accessTickets->getAttributeLabel('payment_option_id') }}</x-base.form-label>
    <x-base.form-input
...
<div class="mb-3">
    ...
    <x-base.form-check>
        ...
        <x-base.form-check.label
                for="approved">{{ $accessTickets->getAttributeLabel('approved') }}</x-base.form-check.label>
    </x-base.form-check>
    @error('approved')
    <div class="mt-2 text-danger">{{ $message }}</div>
    @enderror
...
<div class="mb-3">
    ...
    >
        ...
        @foreach(\App\Models\AccessTicket::getStatusArray() as $key => $label)
