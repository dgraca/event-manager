        ...
        <div class="pt-4">
            <div class="min-h-screen flex flex-col items-center pt-6 sm:pt-0">
                ...
                <div class="w-full sm:max-w-2xl mt-6 p-6 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg prose dark:prose-invert">
                    ...
                    A sua privacidade é importante para nós. É política do Event Manager respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site Event Manager, e outros sites que possuímos e operamos.
                    ...
                    C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Event Manager, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.
                    Mais informações
