<x-app-layout>
    ...
    <h2 class="intro-y mt-10 text-lg font-medium">Temáticas</h2>
        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            <x-base.table class="-mt-2 border-separate border-spacing-y-[10px]">
                ...
                <x-base.table.tbody>
                    @php
                        $array = [
                                'Infraestruturas' => "1º nível",
                                'Passageiros' => "1º nível",
                                'Mercadorias' => "1º nível",
                                'Veículos e formação' => "1º nível",
                                'Preços e política tarifária' => "2º nível",
                                'Qualidade do serviço' => "2º nível",
                                'Concorrência' => "2º nível",
                                'Direitos do utilizadores' => "2º nível",
                        ];
                    @endphp
                        ...
                        <x-base.table.tr class="intro-x">
                            ...
                            >
                                ...
                                <div @class([
                                    ...
                                    'text-success' => $randomBool,
                                    'text-danger' => !$randomBool,
                                ])>
                                    <x-base.lucide
                                        class="mr-2 h-4 w-4"
                                        icon="CheckSquare"
                                    />
                                    {{ $randomBool ? 'Ativo' : 'Inativo' }}
                                </div>
                            </x-base.table.td>
                            <x-base.table.td
