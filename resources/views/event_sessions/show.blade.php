<x-app-layout>
    @section('breadcrumbs')
        {{ Breadcrumbs::render('event-sessions.show', $eventSessions) }}
    @endsection
    <div class="intro-y mt-8 flex flex-col items-center sm:flex-row">
        <h2 class="mr-auto text-lg font-medium">{{ __('Event Sessions Details') }}</h2>
    ...
    <div class="intro-y box mt-3 p-5">
        <dl class="space-y-4">
            @include('event_sessions.show_fields')
        </dl>
    </div>
</x-app-layout>
